...
<?php
	if(isset($_POST["update"]))
	{
		...
		$q="update services set name='".$_POST["name"]."',detail='".$_POST["detail"]."',pic='".$n."' where id='".$_POST["selectid"]."'";	
		$a=mysqli_query($cn,$q);
		if ($a>0)
		 {
	...
	{
		$cn=mysqli_connect("localhost","root","","medilab");
		$q="delete from services where id='".$_POST["selectid"]."'";
		$a=mysqli_query($cn,$q);
		if ($a>0)
		 {
	...
	if (isset($_POST["selectid"]))
	 {
		$cn=mysqli_connect("localhost","root","","medilab");
		$res="select * from services where id='".$_POST["selectid"]."'";
    ...
    <div class="container">
        ...
        <table>
			<tr>
				<td>
					<select name="selectid" class="select-dropdown" name="selectid" onchange="this.form.submit()">
						...
						<?php
						$cn=mysqli_connect("localhost","root","","medilab");
						$q=mysqli_query($cn,"select * from services");
            ...
            <div class="form-group">
				...
				<textarea id="detail" name="detail"><?php if(isset($_POST["selectid"])){echo $detail;}?></textarea>
            </div>
