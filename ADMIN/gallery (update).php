...
<?php include('header.php'); ?>
	...
	if(isset($_POST["update"]))
	{
		...
		$q="update gallery set name='".$_POST["name"]."',pic='".$n."' where id='".$_POST["selectid"]."'";	
		$a=mysqli_query($cn,$q);
		if ($a>0)
		 {
...
<?php
	...
	{
		$cn=mysqli_connect("localhost","root","","medilab");
		$q="delete from gallery where id='".$_POST["selectid"]."'";
		$a=mysqli_query($cn,$q);
		if ($a>0)
		 {
	...
	if (isset($_POST["selectid"]))
	 {
		$cn=mysqli_connect("localhost","root","","medilab");
		$res="select * from gallery where id='".$_POST["selectid"]."'";
    ...
    <div class="container">
		...
		<table>
			<tr>
				<td>
					<select id="optionSelect" class="select-dropdown" name="selectid" onchange="this.form.submit()">
						<option>select</option>
						<?php
						$cn=mysqli_connect("localhost","root","","medilab");
						$q=mysqli_query($cn,"select * from gallery");
            ...
            <button type="submit" name="update" id="update" value="update" class="submit-btn">Update</button>
            <button type="submit" name="delete" id="delete" value="delete" class="submit-btn">Delete</button>
            </form>
    </div>
